  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-emerald-50 p-2 sm:p-4 lg:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Portal Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 px-2 sm:px-0">
          {/* Citizen Portal */}
          ...
          {/* Analyst Portal */}
          <Card className="hover:shadow-lg transition-all duration-200 border-2 hover:border-purple-200 hover:scale-[1.02] sm:col-span-2 lg:col-span-1">
            <CardHeader className="text-center pb-4">
